...
const translations = {
  en: {
    ...
    'app.import.error': 'Failed to import: Invalid CSV file',
    ...
    'chart.waz': 'Weight - Z-Score',
    'chart.lhaz': 'Length - Z-Score',
    'chart.headcz': 'Head Circumference - Z-Score',
    'chart.wflz': 'Weight-for-Length - Z-Score',
    'chart.waz.percentile': 'Weight - Percentile',
    'chart.lhaz.percentile': 'Length - Percentile',
    'chart.headcz.percentile': 'Head Circumference - Percentile',
    'chart.wflz.percentile': 'Weight-for-Length - Percentile',
    'chart.axis.percentile': 'Percentile',
    ...
    'auth.emailSent.claim': 'Check your email to verify your address.',
    'auth.emailSent.claimPassword': 'Password saved! Check your email to verify your address.',
    'auth.emailSent.signIn': 'Check your email for a sign-in link!',
    'auth.setPassword.newPlaceholder': 'New password',
    'auth.setPassword.confirmPlaceholder': 'Confirm password',
    'auth.setPassword.submit': 'Set password',
    'auth.setPassword.success': 'Password set! You can now sign in with your password.',
    ...
    'app.menu': 'Menu',
    'app.print': 'Print',
    'menu.overflow': 'More options',
    'menu.password.change': 'Change password',
    'menu.password.set': 'Set password',
    'auth.setPassword.modalTitle': 'Set password',
    'auth.setPassword.updated': 'Password updated! You can now sign in with your password.',
    'auth.signIn.modalTitle': 'Sign in',
    'auth.claimAccount.modalTitle': 'Save your account',
    'auth.claimAccount.submitPassword': 'Save account',
    'auth.claimAccount.description':
      'Link an email to your guest account so you can access your data from any device.',
    'onboarding.welcome': 'Welcome to Crescere!',
    'onboarding.description':
      "You're viewing sample data for a demo child. Add your own child to start tracking real measurements.",
    'onboarding.saveAccount': 'Create free account',
    'onboarding.guestWelcome': 'You are using guest mode',
    'onboarding.guestDescription':
      'Your data is tied to this browser and could be lost if you clear cookies. Create a free account to keep it safe and access it from any device.',
    'menu.showZScores': 'Show Z-Scores',
    'menu.showPercentiles': 'Show Percentiles',
  ...
  pl: {
    ...
    'app.import.error': 'Nie udało się zaimportować: nieprawidłowy plik CSV',
    'app.clear.confirm':
    ...
    'chart.waz': 'Masa - Z-Score',
    'chart.lhaz': 'Długość - Z-Score',
    'chart.headcz': 'Obwód głowy - Z-Score',
    'chart.wflz': 'Masa do długości - Z-Score',
    'chart.waz.percentile': 'Masa - Percentyl',
    'chart.lhaz.percentile': 'Długość - Percentyl',
    'chart.headcz.percentile': 'Obwód głowy - Percentyl',
    'chart.wflz.percentile': 'Masa do długości - Percentyl',
    'chart.axis.percentile': 'Percentyl',
    ...
    'auth.signUpSent':
      'Konto utworzone! Sprawdź email, aby potwierdzić, a następnie zaloguj się hasłem.',
    'auth.emailSent': 'Sprawdź email!',
    'auth.emailSent.claim': 'Sprawdź email, aby zweryfikować adres.',
    'auth.emailSent.claimPassword': 'Hasło zapisane! Sprawdź email, aby zweryfikować adres.',
    'auth.emailSent.signIn': 'Sprawdź email — znajdziesz tam link do logowania!',
    'auth.setPassword.newPlaceholder': 'Nowe hasło',
    'auth.setPassword.confirmPlaceholder': 'Potwierdź hasło',
    'auth.setPassword.submit': 'Ustaw hasło',
    'auth.setPassword.success': 'Hasło ustawione! Możesz teraz logować się hasłem.',
    'auth.setPassword.mismatch': 'Hasła nie pasują do siebie.',
    'auth.setPassword.tooShort': 'Hasło musi mieć co najmniej 6 znaków.',
    ...
    'app.menu': 'Menu',
    'app.print': 'Drukuj',
    'menu.overflow': 'Więcej opcji',
    'menu.password.change': 'Zmień hasło',
    'menu.password.set': 'Ustaw hasło',
    'auth.setPassword.modalTitle': 'Ustaw hasło',
    'auth.setPassword.updated': 'Hasło zaktualizowane! Możesz teraz logować się hasłem.',
    'auth.signIn.modalTitle': 'Zaloguj się',
    'auth.claimAccount.modalTitle': 'Zapisz swoje konto',
    'auth.claimAccount.submitPassword': 'Zapisz konto',
    'auth.claimAccount.description':
      'Połącz email z kontem gościa, aby mieć dostęp do danych z dowolnego urządzenia.',
    'onboarding.welcome': 'Witaj w Crescere!',
    'onboarding.description':
      'Widzisz przykładowe dane dla demonstracyjnego dziecka. Dodaj własne dziecko, aby śledzić prawdziwe pomiary wzrostu.',
    'onboarding.saveAccount': 'Utwórz darmowe konto',
    'onboarding.guestWelcome': 'Korzystasz z trybu gościa',
    'onboarding.guestDescription':
      'Twoje dane są powiązane z tą przeglądarką i mogą zostać utracone po wyczyszczeniu ciasteczek. Utwórz darmowe konto, aby je zabezpieczyć i mieć dostęp z dowolnego urządzenia.',
    'menu.showZScores': 'Pokaż Z-Score',
    'menu.showPercentiles': 'Pokaż percentyle',
