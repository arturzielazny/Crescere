...
const translations = {
  en: {
    ...
    'auth.setPassword.button': 'Set password',
    'auth.setPassword.title': 'Set a password for your account',
  ...
  pl: {
    ...
    'auth.setPassword.button': 'Ustaw hasło',
    'auth.setPassword.title': 'Ustaw hasło do konta',
